// Tests for tableau-detail lesson: the Detail shelf and multi-dimensional marking.

import { test, describe } from "node:test";
import assert from "node:assert/strict";

import { lesson } from "../lib/guide/lessons/tableau-detail.js";
import { validateLesson } from "../lib/guide/spec.js";

describe("lesson: tableau-detail", () => {
  test("lesson structure is valid", () => {
    assert.equal(lesson.id, "tableau-detail");
