    ...
    },
    {
      ...
      modes: {
        outcome: {
          ...
          hints: [
            "A row counts only when its race matches the group and, at the same time, its decision reads APPROVED.",
    ...
    },
    {
      ...
      modes: {
        outcome: {
          ...
          hints: [
            "Add up loan amounts (column E), but only rows matching both the race and an APPROVED decision.",
