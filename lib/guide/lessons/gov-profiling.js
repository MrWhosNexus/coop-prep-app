  ...
  steps: [
    {
      ...
      instruction:
        "Load /data/hmda-raw.csv into the sheet with A1 as the origin. Before moving on, look at " +
        "what actually arrived: 8 columns, and data down to row 105. Check cell A105 — does the " +
        "last applicant id look like the end of a clean sequence?",
      hints: [
        "The sheet toolbar has a Load CSV button — the file lives at /data/hmda-raw.csv.",
        "Keep the default origin A1 so the headers land in row 1.",
        "104 data rows means the last one sits in row 105.",
        "Click Load CSV, pick hmda-raw.csv, origin A1. H1 reads \"approved\" and A105 reads \"A0072\" — an id from the MIDDLE of the sequence, your first sign this file contains duplicated records.",
      ],
      ...
      modes: {
        outcome: {
          instruction:
            "Get /data/hmda-raw.csv into the sheet so every record is on screen and ready to profile.",
          hints: [
            "The file lives at /data/hmda-raw.csv.",
