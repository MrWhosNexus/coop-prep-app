    ...
    },
    {
      ...
      modes: {
        outcome: {
          ...
          // METHOD grader KEPT in outcome mode, deliberately: on this 32-day
          // row the broken whole-years-plus-remainder hybrid the header
          // documents computes the SAME value as the correct division, so an
          // outcome check on D2 alone cannot tell them apart — only the
          // divisor requirement can. The fill step's rangeValues takes over
          // outcome duty on the 730-day row, where the two methods diverge.
        },
      },
    },
    {
